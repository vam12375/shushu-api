...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/model_health", middleware.HeaderNavModuleAuth("modelHealth"), controller.GetModelHealth)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/ip-guard-status", controller.GetIPGuardStatus)
