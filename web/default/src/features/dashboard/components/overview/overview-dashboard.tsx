...
function SetupGuideBackdrop(props: { compact?: boolean }) {
  return (
    <>
      <div
        className={cn(
          'pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,color-mix(in_oklch,var(--foreground)_5%,transparent)_1px,transparent_1px),linear-gradient(0deg,color-mix(in_oklch,var(--foreground)_5%,transparent)_1px,transparent_1px)] [background-size:24px_24px] dark:opacity-45',
          props.compact
            ? '[mask-image:linear-gradient(90deg,black_0%,black_58%,transparent_86%)] opacity-55'
            : 'opacity-65'
        )}
        aria-hidden='true'
      />
      ...
      <div
        className='bg-card/65 pointer-events-none absolute inset-0'
        aria-hidden='true'
      />
    </>
  )
...
function StartStepItem(props: {
  ...
  return (
    <li className='relative flex gap-3 pb-2.5 last:pb-0'>
      ...
      <Link
        to={props.step.to}
        className='bg-card/80 hover:bg-muted/50 focus-visible:ring-ring flex min-w-0 flex-1 items-center justify-between gap-3 rounded-lg border px-3 py-2.5 text-left shadow-sm transition-colors outline-none focus-visible:ring-2'
      >
...
function RequestPreview(props: {
  ...
  return (
    <motion.div
      ...
      className='bg-card/90 relative overflow-hidden rounded-lg border p-3 shadow-sm backdrop-blur'
    >
      {!shouldReduceMotion && (
        <motion.div
      ...
      <div className='bg-foreground/[0.035] my-3 rounded-lg p-3 font-mono text-xs'>
      ...
      <div className='grid gap-2'>
        {props.signals.map((signal) => {
          ...
          return (
            <div
              key={signal.label}
              className='bg-muted/60 flex items-center justify-between gap-3 rounded-lg px-3 py-2'
            >
    ...
    <div className='flex flex-col gap-4'>
      {setupGuideExpanded ? (
        <CardStaggerContainer className='grid items-stretch gap-4 xl:grid-cols-[minmax(0,1fr)_22rem]'>
          <CardStaggerItem className='bg-card/95 border-border/90 h-full overflow-hidden rounded-lg border shadow-[0_18px_45px_rgb(25_21_14_/_0.08)]'>
            <div className='relative h-full overflow-hidden p-4 sm:p-5'>
              ...
              <div className='relative grid gap-5 lg:grid-cols-[minmax(0,1fr)_21rem]'>
                <div className='flex min-w-0 flex-col gap-5'>
                  ...
                  <ol className='bg-background/55 rounded-lg border p-2 backdrop-blur'>
          ...
          <CardStaggerItem className='bg-card/95 border-border/90 h-full rounded-lg border p-4 shadow-[0_18px_45px_rgb(25_21_14_/_0.08)] sm:p-5'>
        ...
        <CardStaggerContainer>
          <CardStaggerItem className='bg-card/95 border-border/90 overflow-hidden rounded-lg border shadow-[0_18px_45px_rgb(25_21_14_/_0.08)]'>
            <div className='relative overflow-hidden px-4 py-3 sm:px-5'>
              <SetupGuideBackdrop compact />
              <div className='relative flex flex-wrap items-center justify-between gap-3'>
                <div className='flex min-w-0 items-center gap-3'>
                  <span className='bg-accent border-foreground flex size-10 shrink-0 items-center justify-center rounded-full border shadow-[3px_3px_0_var(--foreground)]'>
